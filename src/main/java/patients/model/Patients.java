 ...
 */
@Entity
@Table(name = "patients", catalog = "patients", uniqueConstraints = @UniqueConstraint(columnNames = "PatientID"))
public class Patients implements java.io.Serializable {
	...
	public Patients(Integer patientId, String patientType, String sex, String politeAddress, String letterPoliteAddress, String lastNamePrefix, String title, String firstName, String lastName, Date dateOfBirth, String street,
